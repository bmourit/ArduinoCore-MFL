...
public:
    ...
    auto get_output_value(Internal_Device instance) -> uint16_t;
    ...
    static inline constexpr uintptr_t DAC_baseAddress = 0x4000'7400U;

    [[nodiscard]] inline auto reg_address(DAC_Regs reg) const -> volatile uint32_t* {
